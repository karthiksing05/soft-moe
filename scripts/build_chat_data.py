...
REGISTRY = [
    ...
    ("winograd",   "allenai/winogrande", "winogrande_xl", "train",
                   lambda e: _mc(e["sentence"], [e["option1"], e["option2"]], int(e["answer"]) - 1)),
    ("hellaswag",  "Rowan/hellaswag", None, "train",
                   lambda e: _mc(e["ctx"], e["endings"], int(e["label"]))),
    ("swag",       "allenai/swag", "regular", "train",
                   lambda e: _mc(e["startphrase"], [e["ending0"], e["ending1"], e["ending2"], e["ending3"]], int(e["label"]))),
    ("arc_hard",   "allenai/ai2_arc", "ARC-Challenge", "train",
                   lambda e: _mc(e["question"], e["choices"]["text"], _key_idx(e["choices"], e["answerKey"]))),
    ("medexam",    "openlifescienceai/medmcqa", None, "train",
                   lambda e: _mc(e["question"], [e["opa"], e["opb"], e["opc"], e["opd"]], int(e["cop"]))),
    ("truthful",   "truthful_qa", "generation", "validation",
                   lambda e: (e["question"], e["best_answer"])),
    ("riddle",     "INK-USC/riddle_sense", None, "train",
                   lambda e: _mc(e["question"], e["choices"]["text"], _key_idx(e["choices"], e["answerKey"]))),
    ("cosmos",     "allenai/cosmos_qa", None, "train",
                   lambda e: _mc(e["context"] + " " + e["question"], [e["answer0"], e["answer1"], e["answer2"], e["answer3"]], int(e["label"]))),
    ("quartz",     "allenai/quartz", None, "train",
                   lambda e: _mc(e["question"], e["choices"]["text"], _key_idx(e["choices"], e["answerKey"]))),
    ("dream",      "dataset-org/dream", None, "train",
                   lambda e: _mc(" ".join(e["dialogue"]) + " " + e["question"], e["choice"], list(e["choice"]).index(e["answer"]))),
    ("headqa",     "dvilares/head_qa", "en", "train",
                   lambda e: _mc(e["qtext"], [x["atext"] for x in e["answers"]], int(e["ra"]) - 1)),
    ("dolly",      "databricks/databricks-dolly-15k", None, "train",
                   lambda e: ((e["instruction"] + ("\n" + e["context"] if e.get("context") else "")), e["response"])),
    ("scienceqa",  "derek-thomas/ScienceQA", None, "train",
                   lambda e: _mc(e["question"], e["choices"], int(e["answer"])) if e.get("choices") else None),
]
