...
QUESTIONS = [
    ...
    # --- expanded bank (reduce overfitting: more held-out generalisation signal) ---
    "Describe a snowy morning.", "What's your favorite childhood memory?", "How do you plan a trip?",
    "Tell me about a river.", "What's the best gift you could give?", "Describe a quiet library.",
    "How do you make tea?", "What's your idea of adventure?", "Describe a crowded train.",
    "What's the funniest thing you've seen?", "How do you spend a rainy Sunday?", "Tell me about mountains.",
    "What's your favorite time of day?", "Describe a garden in spring.", "How do you comfort a sad friend?",
    "What's the bravest thing you can do?", "Describe the taste of chocolate.", "How do you welcome a guest?",
    "What's your favorite game?", "Tell me about the desert.", "What would your perfect house look like?",
    "How do you keep a promise?", "Describe a candle burning.", "What's the best meal you've had?",
    "How do you spend New Year's Eve?", "Describe a windy day.", "What's your favorite sound?",
    "How do you learn from mistakes?", "Tell me about a lighthouse.", "What's your dream job?",
    "Describe a busy kitchen.", "How do you say sorry?", "What's the kindest act you've seen?",
    "Describe autumn leaves.", "What's your favorite drink?", "How do you find courage?",
    "Tell me about the sunrise.", "Describe a small village.", "What makes a good leader?",
    "How do you relax after work?", "What's the strangest dream you've had?", "Describe a bakery.",
    "How do you handle a big decision?", "What's your favorite color and why?", "Describe a storm at sea.",
    "How do you make someone laugh?", "What's the best advice you've received?", "Describe a train station.",
    "How do you spend a holiday morning?", "What's your favorite fruit?", "Describe a cozy evening.",
    "How do you deal with fear?", "Tell me about a castle.", "What's worth fighting for?",
    "Describe a field of flowers.", "How do you greet the new year?", "What's your favorite hobby?",
    "How do you show you care?", "Describe a foggy road.", "What's the wildest place you'd visit?",
    "How do you cheer yourself up?", "Tell me about the wind.", "What's your favorite dessert?",
    "Describe a market at dawn.", "How do you make a hard choice?", "What's your happiest place?",
    "Describe a snowfall.", "How do you spend time with family?", "What's the boldest dream you have?",
    "Tell me about a waterfall.", "Describe a warm fireplace.", "How do you say thank you?",
    "What's your favorite weather?", "Describe a long walk.", "How do you find peace?",
    "What's the tastiest snack?", "Describe a starry night.", "How do you welcome spring?",
    "What keeps a friendship strong?", "Describe a rainy window.", "What's your favorite tradition?",
    "How do you start a new project?", "Describe the smell of rain.", "What makes a house a home?",
]
