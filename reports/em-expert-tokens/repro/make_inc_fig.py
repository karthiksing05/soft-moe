...
for arm in d["arms"]:
    ...
    ax[0].plot(s, arm["robot"], "-o", color=c, ms=5, label=arm["name"])
    ax[0].plot(s, arm["base"], "--o", color=c, ms=4, alpha=0.55)
...
ax[0].legend(frameon=False, fontsize=8.5, ncol=3, loc="lower center", title="mechanism")
